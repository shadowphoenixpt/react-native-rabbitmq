...
public class RabbitMqQueue {
  ...
  */
  ...
  public void basicReject(long delivery_tag, boolean reqeue) {
    try {
      this.channel.basicReject(delivery_tag, reqeue);
    } catch (IOException e) {
      Log.e("RabbitMqQueue", "basicReject" + e);
      e.printStackTrace();
    } catch (AlreadyClosedException e) {
      Log.e("RabbitMqQueue AlreadyClosedException", "basicReject" + e);
      e.printStackTrace();
    }
